...
public class BOEJSONArrayNormalizerProvider implements NormalizerProvider {
    @Override
    public String name() {
        return "BOE_JSON_ARRAY_NORMALIZER";
    }
    ...
    public Normalizer<?> create(PluginConfiguration configuration) {
        ...
        return new Normalizer<>(Pipeline.<byte[]>start()
                ...
                .add(new ObservedStep<>("normalize-summary", new NormalizeSummary()))
